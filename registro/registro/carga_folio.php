...
<select name="sec" id="sec" class="easyui-combobox" style="width:100px">
 ...
 <div id="nuevo_titular" class="easyui-dialog" style="width:550px"     buttons="#dlg-buttons">
        <form id="fm_1" name="fm_1" method="post" novalidate style="margin:0;padding:30px 70px">
            <div style="margin-bottom:20px;font-size:14px;border-bottom:1px solid #ccc">Agragar Titular</div>
            <div style="margin-bottom:10px">Apellido 
                <input name="apellidonombre" class="easyui-textbox" required="true" label="Apeynom" style="width:100%">
            </div>
            <div style="margin-bottom:10px">Nombre
                <input name="nombre" class="easyui-textbox" required="true" label="Dni" style="width:100%">
            </div>
            <div style="margin-bottom:10px">DNI
                <input name="nro_doc" class="easyui-textbox" required="true" label="Dni" style="width:100%">
            </div>
            <div style="margin-bottom:10px">Cuil
                <input name="cuit" class="easyui-textbox"  label="Cuil" style="width:100%">
            </div>
            <div style="margin-bottom:10px">Localidad
                <input name="localidad" class="easyui-textbox" required="true" label="Barrio" style="width:100%">
            </div>
            <div style="margin-bottom:10px">Nacionalidad
                <input name="Nacionalidad" class="easyui-textbox" required="true" label="Barrio" style="width:100%">
            </div>
           <div style="margin-bottom:10px">Conyugue
                <input name="datos_conyugue" class="easyui-textbox" required="true" label="Barrio" style="width:100%">
            </div>
    ...
    <div id="dlg-buttons">
        <a href="#" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="ver_titular_nuevo()" style="width:90px">Agragar</a>
...
/*/
   ...
   $('#buscar_dni').dialog('open').dialog('center').dialog('setTitle','Buscar');
     ...
     function datos_titular(dni){
      ...
      $('#nuevo_titular').dialog('open').dialog('center').dialog('setTitle','Persona');
      $('#fm_1').form('load',
        url= 'backend/titulares.php?dni='+dni,
       );
